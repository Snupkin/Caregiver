//
//  SymptomResearchListTableViewController.m
//  CareGiver 1.0
//
...
@interface SymptomResearchListTableViewController ()

@end

@implementation SymptomResearchListTableViewController
...
- (void)viewDidLoad {
    ...
    // Filter self.labArray to only be matching symptoms
    int i,j;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"SymptomResearchTableCell" forIndexPath:indexPath];
